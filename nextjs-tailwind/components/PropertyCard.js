         ...
         <div>
            ...
            <div className="relative px-4 -mt-16">
                <div className="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    { 
                        Array.from(property.rating).forEach((index) => {
                        return (
                            <svg v-for="i in 5" key={i} viewBox="0 0 24 24" className={ i <= property.rating ? 'text-teal-500' : 'text-gray-400'} className="h-4 w-4 fill-current">
